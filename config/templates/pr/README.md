...
|---|---|---|
| 👥 Non-technical summary | Always | Why should anyone care? |
...
| Non-technical summary full of identifiers | It is a second technical summary, not one anyone can read. |
...
one of them shipped without a non-technical summary and without a test plan. All
